...
class PetFriends:
    ...
    def add_new_pet_simple_CTA(self, auth_key: json, name: str, animal_type: str, age: str,  cont_type: str, access: str) -> json:
        """Метод отправляет (постит) на сервер данные о добавляемом питомце и возвращает статус
        запроса и результат в формате JSON с данными добавленного питомца"""
        ...
        headers = {'auth_key': auth_key['key'], 'Content-Type': cont_type, 'Access': access}
